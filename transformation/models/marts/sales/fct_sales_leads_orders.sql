...
lead_join_qualified as (
	select
	    ...
	    COALESCE(l.salesperson_city, q.salesperson_city) AS salesperson_city,
	    COALESCE(l.sales_position, q.sales_position) AS sales_position,
	    ...
	    COALESCE(l.expected_delivery_date, q.expected_delivery_date) AS expected_delivery_date,
