...
all_schedules = haravan_schedules + frappe_erpnext_schedules + nocodb_schedules + pancake_schedules

__all__ = ["all_schedules", "frappe_erpnext_schedules", "haravan_schedules", "nocodb_schedules", "pancake_schedules"]
