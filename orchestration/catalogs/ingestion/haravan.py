...
HARAVAN_EXECUTION_UNITS = validate_execution_units(
    (
        ...
        ExecutionUnitSpec(
            ...
            tool="dlt",
            system="haravan",
            unit="inventory_locations_balance_daily_snapshot",
            asset_paths=_asset_paths("inventory_locations_balance_daily_snapshot"),
            description="Daily snapshot of Haravan inventory_locations into inventory_locations_balance_daily_snapshot (adds snapshot_date)",
            cadence="daily",
            cron_schedule="0 17 * * *",
            schedule_token="daily_17utc",
            schedule_description="Copy Haravan inventory_locations into daily balance snapshot at 00:00 ICT (17:00 UTC)",
