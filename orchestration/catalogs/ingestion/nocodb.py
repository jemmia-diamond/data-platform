...
NOCODB_EXECUTION_UNITS = validate_execution_units(
    (
        ...
        ExecutionUnitSpec(
            ...
            asset_paths=_asset_paths("diamonds", "diamond_price_list", "moissanite"),
            description="Sync diamond inventory: diamonds, diamond_price_list, moissanite",
            cadence="hourly",
            cron_schedule="02 * * * *",
        ...
        ExecutionUnitSpec(
            ...
            unit="inventory",
            name_segments=("nocodb",),
            asset_paths=_asset_paths("variant_serials", "jewelries", "temporary_products"),
            description="Sync physical inventory: variant_serials, jewelries, temporary_products",
            cadence="hourly",
            cron_schedule="42 * * * *",
            schedule_token="every_1h",
        ...
        ExecutionUnitSpec(
            ...
            unit="design_core",
            name_segments=("nocodb",),
            asset_paths=_asset_paths("designs", "design_details", "design_design_images"),
            description="Sync R&D design data: designs, design_details, design_design_images",
            cadence="2hourly",
            cron_schedule="12 */2 * * *",
