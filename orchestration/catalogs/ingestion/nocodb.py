...
NOCODB_EXECUTION_UNITS = validate_execution_units(
    (
        ...
        ExecutionUnitSpec(
            ...
            name_segments=("nocodb",),
            asset_paths=_asset_paths("products", "variants", "ecom_360"),
            description="Sync product catalog: products, variants, ecom_360",
            cadence="hourly",
            cron_schedule="22 * * * *",
            schedule_token="every_1h",
        ...
        ExecutionUnitSpec(
            ...
            unit="design_core",
            name_segments=("nocodb",),
            asset_paths=_asset_paths("designs", "design_details", "design_design_images", "wedding_rings", "sets", "design_set"),
            description="Sync R&D design data: designs, design_details, design_design_images, wedding_rings, sets, design_set",
            cadence="2hourly",
            cron_schedule="12 */2 * * *",
