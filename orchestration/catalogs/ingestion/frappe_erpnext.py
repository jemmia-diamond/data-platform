...
FRAPPE_ERPNEXT_EXECUTION_UNITS = validate_execution_units(
    (
        ...
        ExecutionUnitSpec(
            ...
            asset_paths=_asset_paths("lead_products", "opportunities", "note"),
            description="Refresh ERPNext lead products, opportunities, and notes",
            cadence="10m",
            name_segments=FRAPPE_ERPNEXT_NAME_SEGMENTS,
            cron_schedule="5,15,25,35,45,55 * * * *",
            schedule_token="every_10m",
            schedule_description="Run ERPNext lead products, opportunities, and notes every 10 minutes",
